let { book } = require ('./category/rust.js.js.js')
let { advrust } = require ('./category/advrust.js.js.js')
let { asyncrust } = require ('./category/asyncrust.js.js.js')
let { reference } = require ('./category/reference.js.js.js')
let { cargo } = require ('./category/cargo.js.js.js')
let { tokio } = require ('./category/tokio.js.js.js')
let { actix } = require ('./category/actix.js.js.js')
let { actixweb } = require ('./category/actixweb.js.js.js')
let { diesel } = require ('./category/diesel.js.js.js')
let { riker } = require ('./category/riker.js.js.js')
let { discovery } = require ('./category/discovery.js.js.js')
let { serde } = require ('./category/serde.js.js.js')
let { www } = require ('./category/www.js.js.js')
let { tokio_blog } = require ('./category/tokio_blog.js.js.js')
let { book_exp } = require ('./category/user/book-exp.js.js.js')
